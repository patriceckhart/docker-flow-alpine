...
LABEL org.label-schema.docker.dockerfile="/Dockerfile" \
	...
	org.label-schema.name="Neos Flow Alpine Docker Image" \
	org.label-schema.url="https://github.com/patriceckhart/docker-flow-alpine" \
	org.label-schema.vcs-url="https://github.com/patriceckhart/docker-flow-alpine" \
